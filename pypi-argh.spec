...
BuildRequires : pypi(argparse)
BuildRequires : pypi(iocapture)
...
%prep
%setup -q -n argh-0.26.2
cd %{_builddir}/argh-0.26.2
pushd ..
cp -a argh-0.26.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656356012
